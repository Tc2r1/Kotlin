package com.nudennie.gdgfinder.search
...
import com.nudennie.gdgfinder.databinding.FragmentGdgListBinding
...
class GdgListFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val adapter = GdgListAdapter(
            GdgClickListener { chapter ->
            ...
            object : Observer<List<String>> {
                override fun onChanged(data: List<String>?) {
                    ...
                    val children = data.map { regionName ->
                        val chip = inflator.inflate(R.layout.regions, chipGroup, false) as Chip
