...
import com.nudennie.dessertpusher.databinding.ActivityMainBinding
import timber.log.Timber

const val KEY_REVENUE = "key_revenue"
const val KEY_DESSERTS_SOLD = "key_desserts_sold"
const val KEY_DESSERT_TIME = "key_dessert_time"
...
class MainActivity : AppCompatActivity(), LifecycleObserver {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        savedInstanceState?.let {
            ...
            dessertTimer.secondsCount = it.getInt(KEY_DESSERT_TIME, 0)
        }
    ...
    override fun onSaveInstanceState(outState: Bundle) {
        ...
        outState.putInt(KEY_DESSERT_TIME, dessertTimer.secondsCount)
